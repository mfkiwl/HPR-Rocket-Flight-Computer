...
//Built for the Teensy 3.2, 3.5, 3.6, 4.0, and 4.1
//Code Line Count: 9113 lines of code = 2280 MainFile + 365 Bus_Mgmt + 2424 SensorDrivers + 887 Calibration + 625 SpeedTrig + 525 Inflight_Recover + 618 SD + 397 Rotation + 371 Telemetry + 327 Event_Logic + 292 GPSconfig      
//--------FEATURES----------
...
//V4_3_5_2 is a stand-alone version that evaluates cycle time diagnostics in order to ID chokepoints in the loop.  Results are nearly the same as the previous test done in 2019'ish
...
void loop(void){
  ...
  if (events.liftoff) {
    ...
    if(!sensors.status_NoHighGAccel){
      getHighG(threeAxisMode);
